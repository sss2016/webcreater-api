...
import {getButtonDom,getFormDom_prod,getImageDom,getCarouselDom,getArticleDom 
} from '../../configs/ssrCom';
                  ...
                  <div  key={i} style={style}>
                      ...
                      _.map(l.cols,(v,k)=>{
                        ...
                        return(  
                         ...
                         style={{width:v.type==='article'?"100%":v.layout.width,height:v.layout.height,
    ...
    render() {
        return (
            <div>
                ...
                style={{position:'absolute',right:10,top:'50%',fontSize:'40px',width:40,height:40}}
